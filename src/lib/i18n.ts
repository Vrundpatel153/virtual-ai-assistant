...
const dict = {
  ...
  settingsSaved: 'Settings saved.',
    ...
    dailyTokenLimitMessage: "You've used your daily token limit. Start the Groq backend server or upgrade your plan to continue.",
    configureEnvKey: 'Backend setup guide',
    ...
    aiKeyRequired: 'AI backend unavailable. Local automations ran if available.',
  ...
  settingsSaved: 'सेटिंग्स सहेजी गईं।',
    ...
    dailyTokenLimitMessage: 'आपने आज की टोकन सीमा का उपयोग कर लिया है। जारी रखने के लिए Groq बैकएंड सर्वर चालू करें या अपना प्लान अपग्रेड करें।',
    configureEnvKey: 'बैकएंड सेटअप गाइड',
    ...
    aiKeyRequired: 'एआई बैकएंड उपलब्ध नहीं है। उपलब्ध होने पर स्थानीय कार्य चलाए गए।',
